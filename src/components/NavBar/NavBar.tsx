        ...
        <nav className='nav' ref={navRef}>
            <ul>
              ...
              <Link to='/contact' className='nav__link' onClick={showNavBar}>
                <Button buttonType='primary' className='nav__link--btn'>Contact</Button>
              </Link>
            </ul>
          </nav>
              ...
              <Button buttonType='' className='nav__responsive__btn' 
                onClick={showNavBar}>
                {
                  navIcons === true 
                    ? <FaTimes className='nav__close__btn--icon'/>
                    : <FaBars className='nav__open__btn--icon'/>
                }
              </Button>
        </div>
      </NavBarWrapper>
